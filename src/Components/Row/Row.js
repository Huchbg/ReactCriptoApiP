...
import {StyledRow ,StyledImage,StyledTitle,StyledSpan,StyledPrice,StyledPriceBig,StyledLink} from "./elements"
...
export const Row=(props)=>{
    ...
    return (
        <StyledRow>
            ...
            <StyledPriceBig>$ {props.Totprice.toLocaleString('en-US')}</StyledPriceBig>
